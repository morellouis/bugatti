...
window.addEventListener("scroll", () => {
    var hauteurPage = document.documentElement.scrollHeight - window.innerHeight;
    var positionDeScroll = window.scrollY;
    var pourcentageDeScroll = (positionDeScroll / hauteurPage) * 100;
    scroll_bar.style.width = `${pourcentageDeScroll}vw`;
});